...
def upgrade():
    ...
    sa.Column('stake_balance', sa.Integer(), nullable=True),
    ...
    op.create_table('arena_transaction',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('staked_amount', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['miner_id'], ['user.id'], ),
    sa.ForeignKeyConstraint(['transaction_id'], ['arena_transaction.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('vote')
    op.drop_table('arena_transaction')
    with op.batch_alter_table('user', schema=None) as batch_op:
